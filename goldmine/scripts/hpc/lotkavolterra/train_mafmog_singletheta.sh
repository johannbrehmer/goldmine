...
./train.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 200000 --singletheta --trainsample train_zoom --modellabel model_zoom_mog --components 10
./train.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 500000 --singletheta --trainsample train_zoom --modellabel model_zoom_mog --components 10
./train.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 1000000 --singletheta --trainsample train_zoom --modellabel model_zoom_mog --components 10
