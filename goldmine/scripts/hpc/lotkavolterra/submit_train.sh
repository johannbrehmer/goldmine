...
sbatch --array=5-9 train_rascal.sh
sbatch --array=5-9 train_cascal.sh
sbatch --array=5-9 train_rolr.sh
sbatch --array=5-9 train_carl.sh

sbatch --array=0-0 train_mafmog_singletheta.sh
