...
./test.py lotkavolterra scandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 1000 --densitygrid --ratiogrid --density --score  --testsample test_focus --modellabel model_focus
./test.py lotkavolterra scandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 2000 --densitygrid --ratiogrid --density --score --testsample test_focus --modellabel model_focus
./test.py lotkavolterra scandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 5000 --densitygrid --ratiogrid --density --score --testsample test_focus --modellabel model_focus
./test.py lotkavolterra scandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 10000 --densitygrid --ratiogrid --density --score --testsample test_focus --modellabel model_focus
