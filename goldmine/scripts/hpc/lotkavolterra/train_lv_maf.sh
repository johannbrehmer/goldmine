...
./train.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 5000
...
./train.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 500000
./train.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 1000000
