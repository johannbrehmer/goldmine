...
#./test.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 500000 --classifiertest
#./test.py lotkavolterra maf -i ${SLURM_ARRAY_TASK_ID} --samplesize 1000000 --classifiertest
