...
./test.py lotkavolterra scandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 500000 --densitygrid --ratiogrid --density --score --testsample test_zoom --model model_zoom_mog
#./test.py lotkavolterra scandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 1000000 --densitygrid --ratiogrid --density --score --testsample test_zoom --model model_zoom_mog
