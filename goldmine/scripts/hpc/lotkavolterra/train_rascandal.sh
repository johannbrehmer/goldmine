...
./train.py lotkavolterra rascandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 200000 --alpha 0.01 --beta 0.01 --trainsample train_zoom --modellabel model_zoom
./train.py lotkavolterra rascandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 500000 --alpha 0.01 --beta 0.01 --trainsample train_zoom --modellabel model_zoom
./train.py lotkavolterra rascandal -i ${SLURM_ARRAY_TASK_ID} --samplesize 1000000 --alpha 0.01 --beta 0.01 --trainsample train_zoom --modellabel model_zoom
