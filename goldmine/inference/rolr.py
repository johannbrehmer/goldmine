...
from goldmine.ml.losses import ratio_mse


class ROLRInference(RatioInference):
    ...
    def fit(self,
        ...
        logging.info('Training ROLR (ratio regression) with settings:')
