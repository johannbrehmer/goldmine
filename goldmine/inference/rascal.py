...
from goldmine.ml.losses import score_mse, ratio_mse
...
class RASCALInference(RatioInference):
    ...
    def fit(self,
        ...
        logging.info('Training RASCAL (ratio + score regression) with settings:')
        ...
        train_model(
            ...
            loss_functions=[ratio_mse, score_mse],
            loss_weights=[1., alpha],
            loss_labels=['ratio', 'score'],
            thetas=theta,
            xs=x,
            ys=y,
            t_xzs=t_xz,
